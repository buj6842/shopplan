...
<!-- 게시판 수정 -->
			<form action="${pageContext.request.contextPath}/community/CommunityModifyOk.ct" method="post" name="modifyForm" enctype="multipart/form-data">
				...
				<table width="900px" border="1" cellpadding="0" cellspacing="0">
					<tr height="30px">
						...
						<td style="padding-left:10px;">
							<input name="community_title" type="text" size="50" maxlength="100" value="${CommunityBean.getCommunity_title()}" />
						</td>
					</tr>
					<tr height="30px">
						<td align="center" width="150px">
						...
						<td style="padding-left:10px;">
							<input name="community_id" type="text" size="10" maxlength="10" value="${session_id}" readonly/>
						</td>
					</tr>
					<tr height="200px">
						<td align="center" width="150px">
						...
						<td style="padding-left:10px;">
							<textarea name="community_content" style="width:700px; height:185px; resize:none;">${CommunityBean.getCommunity_content()}</textarea>
						</td>
					</tr>
					<tr height="30px">
						<td align="center" width="150px">
