...
<html>
	<head>
		...
		<link rel="stylesheet" href="${pageContext.request.contextPath}/app/user/input.css" />
	</head>
		...
		<!-- Main -->
			...
			<p></p>
				...
				<form name="joinForm" method="post" action="${pageContext.request.contextPath}/user/UserJoinOk.us" >
					...
					<p style="margin-left:36%; margin-bottom:10px;">PW</p>
					<div class="row gtr-uniform"style="display:contents;">
					<div class="col-4 col-12-small" style="margin:auto;     padding-top:0px;">
					...
					<p style="margin-left:36%; margin-bottom:10px;">PHONE</p>
					<div class="row gtr-uniform"style="display:contents;">
					<div class="col-4 col-12-small" style="margin:auto;     padding-top:0px;">
					<input type="text" name="user_phone_number" value=""  required/>
					</div>
					</div>
				   ...
				   <p style="margin-left:36%; margin-bottom:10px;">NAME</p>
					...
					<p style="margin-left:36%; margin-bottom:10px;">E_MAIL</p>
					<div class="row gtr-uniform"style="display:contents;">
					<div class="col-4 col-12-small" style="margin:auto;     padding-top:0px;">
					...
					<p style="margin-left:36%; margin-bottom:10px;">USER AGE</p>
					<div class="row gtr-uniform"style="display:contents;">
					<div class="col-4 col-12-small" style="margin:auto;     padding-top:0px;">
					...
					<br>
						...
						<p style="text-align:center;">나만의 공간에 색상을 선택해 보세요!</p>
						<div style="padding-left:25%; padding-bottom:20px;" >
						<div class="col-6 col-12-small">
						<ul class="actions" style="margin: 0 auto;">
						<li style="padding-right: 6px;"></li>
						<input type ="button"  class="button primary" value = "Living Room color_click" 
						onclick="goLivingroom()" style="width:35%;"/>
						<input type="text" " name="user_livingroom_c" id="user_livingroom_c" value="Chooes Color"  
								style="width:25%;  margin-left:15px;" readonly/>
						</ul>
						</div>
						</div>
						...
						<ul class="actions" style="margin: 0 auto;">
						<li style="padding-right: 6px;"></li>
						<input type ="button"  class="button primary"  value = "kitchen room color_click" 
								class="button primary"  onclick="goKitchen()" style="width:35%;"/>
						<input type="text" " name="user_kitchen_c" id="user_kitchen_c" value="Chooes Color" style="width:25%;  margin-left:15px;"readonly/>
						</ul>
						</div>
						</div>
						
						<div style="padding-left:25%; padding-bottom:80px;" >
						<div class="col-6 col-12-small">
						<ul class="actions" style="margin: 0 auto;">
						<li style="padding-right: 6px;"></li>
						<input type ="button" class="button primary"  value = "Main room color_click" 
								 class="button primary" onclick="goRoom()" style="width:35%;"/>
						<input type="text" " name="user_room_c" id="user_room_c"  value="Chooes Color"  style="width:25%;  margin-left:15px;" readonly/>
						</ul>
						</div>
						</div>
					...
					<p style="margin-left:36%; margin-bottom:10px;">GENDER</p>
					<div class="row gtr-uniform"style="display:contents;">
					<div class="col-12" style= "padding-top:0px;">
					<select name="user_gender" id="user_gender" style="margin:auto; width:32%;">
					...
					<p style="margin-left:36%; margin-bottom:10px;">우편번호</p>
					<div class="row gtr-uniform" style="display:contents;">
					<div class="col-4 col-12-small" style="margin:auto; padding-top:0px">
					<input type="text" name="user_zipcode" class="postcodify_postcode5" value=""  readonly/>
					<input type="button"  class="button primary fit"   id="postcodify_search_button" 
							  style="margin-top:10px" value="검색하기" />
					</div>
					</div>
					
					<p></p>
					
					<p style="margin-left:36%; margin-bottom:10px;">주소</p>
					<div class="row gtr-uniform" style="display:contents;">
					<div class="col-4 col-12-small" style="margin:auto;     padding-top:0px;">
					<input type="text" name="user_address"  class="postcodify_address" value="" />
					</div>
					</div>
					
					<p></p>
					
					<p style="margin-left:36%; margin-bottom:10px;">상세주소</p>
					<div class="row gtr-uniform"style="display:contents;">
					<div class="col-4 col-12-small" style="margin:auto;     padding-top:0px;">
					<input type="text" name="user_address_detail"  class="postcodify_details" value="" />
					</div>
					</div>
					...
					<p style="margin-left:36%; margin-bottom:10px;">참고항목</p>
					<div class="row gtr-uniform"style="display:contents;">
					<div class="col-4 col-12-small" style="margin:auto;     padding-top:0px;">
					<input type="text" name="user_address_etc"  class="postcodify_extra_info" value="" />
					</div>
					</div>
					...
					<br>
						...
						<p style="margin-left:36%; margin-bottom:10px;">회원가입 이용 약관</p>
						<div class="row gtr-uniform"style="display:contents;">
						<div class="col-4 col-12-small" style="margin:auto;     padding-top:0px;">
					
						<textarea name="message" id="message" placeholder="Enter your message" cols="10" rows="6" style="margin:0 auto; resize: none;" readonly > 
시행일자 : 2020년 11월 16일

제1조 (목적)
본 약관은 #plan(이하 '회사')가 고도 사이트(이하 ‘사이트’)를 통하여 인터넷상에서 제공하는 서비스(이하 ‘서비스’)를 이용하는 고객 (이하 '고객')간의 권리와 의무 및 책임 등 기타 제반사항을 규정함을 목적으로 합니다.
...
본 약관은 2020년 11월 16일부터 적용하고, 2016년 5월 2일부터 시행되던 종전의 약관은 본 약관으로 대체합니다.
						...
						<div class="col-6 col-12-small" style="margin: 0 auto; text-align: center; padding-bottom:30px;">
						<input type="checkbox" id="copy" name="copy" checked>
						<label for="copy"><span span style="color:red; font-weight:900">[필수]&nbsp;</span>약관 및 개인정보 수집 /이용 동의</label>
						</div>
						
						
						<div class="col-3 col-12-small" style="margin: 0 auto; padding-bottom:30px">
						<ul class="actions stacked" >
						<a href="javascript:formSubmit()" class="button primary fit">가입하기</a>
						</ul>
						</div>
						
						<!-- <div class="col-3 col-12-small" style="padding-bottom:30px">
						<ul class="actions stacked" >
						<li style="margin: 0 auto; width:20%;"><a href="javascript:formSubmit()" class="button primary fit">가입하기</a></li>
						</ul>
						</div> -->
