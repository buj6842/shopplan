...
<link rel="stylesheet" href="${pageContext.request.contextPath}/app/user/room.css" />
</head>
...
<!--  <form action="">-->
  ...
  <img src="${pageContext.request.contextPath}/app/user/images/room.png" /> 
      <input type="text" name="room_color" id="room_color" value=""
      		style="margin-left:33%" readonly/>

      <input type="button" value="저장!" onclick="setRoom()">
</form>
</div>
...
<script>
   $("input[name='color']").click(function(){
      $("input[name='room_color']").val($(this).attr("id"));
   })
   
   function setRoom(){
	opener.document.getElementById("user_room_c").value = document.getElementById("room_color").value;
	window.close();
}
