     ...
     <!-- Menu -->
		...
		<!-- Main -->
			...
			<p></p>
				...
				<form name="exjoinForm" method="post" action="${pageContext.request.contextPath}/user/UserJoinOK.us" >
					...
					<input type="button" onclick="checkId()"  class="button primary fit"  style="margin-top:10px" value="중복확인" />
					</div>
					</div>
					...
					<div class="row gtr-uniform"style="display:contents;">
					<div class="col-4 col-12-small" style="margin:auto;     padding-top:0px;">
					<input type="text" name="ex_pw" value=""  />
					</div>
					</div>
					...
					<div class="row gtr-uniform"style="display:contents;">
					<div class="col-4 col-12-small" style="margin:auto;     padding-top:0px;">
					<input type="text" name="ex_tirename" value=""/>
					</div>
					</div>
					...
					<select name="category" id="ex_gender" style="margin:auto; width:32%;">
					<option value="">- 성별선택 -</option>
					<option value="1" name="ex_gender" value="남성">남성</option>
					<option value="1" name="ex_gender" value="여성">여성</option>
					</select>
					</div>
					</div>
				...
				<br>
						...
						<p style="margin-left:36%; margin-bottom:10px;">전문가 파일</p>
						<div class="row gtr-uniform"style="display:contents;" >
						<div class="col-4 col-12-small" style="margin:auto; ">
						<input type="file"  name="ex_file"  style="margin:auto; width:100%;"/>
						</div>
						</div>
...
본 약관은 2020년 11월 16일부터 적용하고, 2016년 5월 2일부터 시행되던 종전의 약관은 본 약관으로 대체합니다.
						...
						<a href="javascript:formSubmit()" class="button primary fit">가입신청하기</a>
						</ul>
						</div>
