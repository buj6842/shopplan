...
<link rel="stylesheet" href="${pageContext.request.contextPath}/app/user/kitchen.css" />
</head>
...
<form>
  ...
  <img src="${pageContext.request.contextPath}/app/user/images/kitchen.png" /> 
  
      <input type="text" name="kitchen_color" id="kitchen_color" value=""
      	style="margin-left:33%"/>

      <input type="button" value="저장!" onclick="setKitchen()">
  </form>
	</div>
...
<script>
   $("input[name='color']").click(function(){
      $("input[name='kitchen_color']").val($(this).attr("id"));
   })
   
   function setKitchen(){
	opener.document.getElementById("user_kitchen_c").value = document.getElementById("kitchen_color").value;
	window.close();
}
