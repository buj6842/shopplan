		...
		<!-- Main -->
			...
			<p></p>
				<section class="wrapper"style="text-align:center">
					<div class="inner" >
					<h2>EXPERT JOIN US </h2>
					<hr></hr>
					</div>
				</section>
							
				<form action="${pageContext.request.contextPath}/expert/ExpertJoinOk.ex"  name="exjoinForm"  method="post"  enctype="multipart/form-data">
					...
					<input type="button" onclick="javascript:checkExId()"  class="button primary fit"  style="margin-top:10px" value="중복확인" />
					</div>
					</div>
					...
					<div class="row gtr-uniform"style="display:contents;">
					<div class="col-4 col-12-small" style="margin:auto;     padding-top:0px;">
					<input type="password" name="ex_pw" value=""  />
					</div>
					</div>
					...
					<div class="row gtr-uniform"style="display:contents;">
					<div class="col-4 col-12-small" style="margin:auto;     padding-top:0px;">
					<input type="text" name="ex_expert_name" value=""/>
					</div>
					</div>
					...
					<div class="row gtr-uniform"style="display:contents;">
					<div class="col-4 col-12-small" style="margin:auto;     padding-top:0px;">
					<input type="text" name="ex_phone_num" value=""  required/>
					</div>
					</div>
					...
					<div class="row gtr-uniform"style="display:contents;">
					<div class="col-4 col-12-small" style="margin:auto;"    padding-top:0px;">
					<input type="email" name="ex_email" value=""/>
					</div>
					</div>
				...
				<p></p>
					...
					<select name="ex_gender" id="ex_gender" style="margin:auto; width:32%;">
					<option value="">- 성별선택 -</option>
					<option value="1" name="ex_gender" value="남성">남성</option>
					<option value="2" name="ex_gender" value="여성">여성</option>
					</select>
					</div>
					</div>
				...
				<p style="text-align: center;">파일을 등록해 주세요.</p>
				...
				<table>
					...
					<div class="row gtr-uniform" style="display:contents;">
					<div class="col-4 col-12-small" style="margin:auto; padding-top:0px">
					<input type="text" name="ex_zipcode" class="postcodify_postcode5" value=""  readonly/>
					...
					<div class="row gtr-uniform" style="display:contents;">
					<div class="col-4 col-12-small" style="margin:auto;     padding-top:0px;">
					<input type="text" name="ex_address"  class="postcodify_address" value="" />
					</div>
					</div>
					...
					<div class="row gtr-uniform"style="display:contents;">
					<div class="col-4 col-12-small" style="margin:auto;     padding-top:0px;">
					<input type="text" name="ex_address_detail"  class="postcodify_details" value="" />
					</div>
					</div>
					...
					<div class="row gtr-uniform"style="display:contents;">
					<div class="col-4 col-12-small" style="margin:auto;     padding-top:0px;">
					<input type="text" name="ex_address_etc"  class="postcodify_extra_info" value="" />
					</div>
					</div>
...
본 약관은 2020년 11월 16일부터 적용하고, 2016년 5월 2일부터 시행되던 종전의 약관은 본 약관으로 대체합니다.
						...
						<a href="javascript:addExjoin()" class="button primary fit sendPw">가입신청하기</a>
						</ul>
						</div>
			</div>
			</form>
			...
			<script src="${pageContext.request.contextPath}/app/expert/exjoin.js"></script>
			 <script>
				$("a.sendPw").on("click", function(e) {
					...
					if (exjoinForm.ex_pw.value == "") {alert("비밀번호를 입력해주세요."); return false; }
					if (exjoinForm.ex_name.value == "") {alert("담당자명을 입력해주세요.");return false;}
					if (exjoinForm.ex_expert_name.value == "") {alert("업체명을 입력해주세요.");return false;}
					if (exjoinForm.ex_phone_num.value == "") {alert("핸드폰 번호를 입력해주세요.");return false;}
					if (exjoinForm.ex_email.value == "") {alert("이메일을 입력해주세요.");return false;}
				
					exjoinForm.submit();
				})
	</script>
			<script> function addExjoin(){exjoinForm.submit(); }  	</script>
			<script>
